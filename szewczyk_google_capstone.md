...
![](szewczyk_google_capstone_files/figure-commonmark/unnamed-chunk-7-1.png)
...
```
    ...
    # A tibble: 2 × 4
      ...
      <chr>                   <dbl>             <dbl>              <dbl>
    1 Guest                    22.0             13.1                39.6
    2 Member                   12.4              8.83               18.9
...
![](szewczyk_google_capstone_files/figure-commonmark/unnamed-chunk-9-1.png)
...
```
    ...
    # Groups:   member_casual [2]
      ...
      <chr>         <chr>           <dbl>
    1 Guest         Classic         38.1 
    2 Guest         Docked           7.67
    3 Guest         Electric        54.2 
    4 Member        Classic         51.1 
    5 Member        Electric        48.9 
...
![](szewczyk_google_capstone_files/figure-commonmark/unnamed-chunk-11-1.png)
...
```
    ...
    # Groups:   member_casual [2]
      ...
      <chr>         <fct>         <dbl>
    1 Guest         Mid-Night      5.46
    2 Guest         Evening       30.4 
    3 Guest         Afternoon     45.3 
    4 Guest         Morning       18.8 
    5 Member        Mid-Night      3.59
    6 Member        Evening       26.6 
    7 Member        Afternoon     42.6 
    8 Member        Morning       27.2 
...
![](szewczyk_google_capstone_files/figure-commonmark/unnamed-chunk-13-1.png)
...
![](szewczyk_google_capstone_files/figure-commonmark/unnamed-chunk-16-1.png)
...
![](szewczyk_google_capstone_files/figure-commonmark/unnamed-chunk-19-1.png)
...
```
    ...
    # Groups:   member_casual [2]
      ...
      <chr>         <chr>              <dbl>
    1 Guest         Weekday             62.5
    2 Guest         Weekend             37.5
    3 Member        Weekday             75.0
    4 Member        Weekend             25.0
...
![](szewczyk_google_capstone_files/figure-commonmark/unnamed-chunk-21-1.png)
...
```
    ...
    # Groups:   member_casual [2]
      ...
      <chr>         <chr>                   <dbl>
    1 Guest         Weekday                 12.1 
    2 Guest         Weekend                 15.1 
    3 Member        Weekday                  8.57
    4 Member        Weekend                  9.73
...
![](szewczyk_google_capstone_files/figure-commonmark/unnamed-chunk-23-1.png)
...
```
    ...
    # Groups:   member_casual [2]
       ...
       <chr>         <fct>  <int>
     1 Guest         Nov21 106735
     2 Guest         Dec21  69594
     3 Guest         Jan22  18450
     4 Guest         Feb22  21350
     5 Guest         Mar22  89647
     6 Guest         Apr22 126121
     7 Guest         May22 279801
     8 Guest         Jun22 368141
     9 Guest         Jul22 405237
    10 Guest         Aug22 358241
    # ℹ 14 more rows
...
![](szewczyk_google_capstone_files/figure-commonmark/unnamed-chunk-25-1.png)
...
![](szewczyk_google_capstone_files/figure-commonmark/unnamed-chunk-28-1.png)
